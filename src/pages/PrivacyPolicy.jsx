...
const PrivacyPolicy = () => {
  return (
    <>
      <Helmet>
        <title>Privacy Policy | BGM Library</title>
        <meta
          name="description"
          content="BGM Library's Privacy Policy. Learn how we collect, use, and protect your personal information in compliance with GDPR regulations."
        />
        <link rel="canonical" href="https://convoyafro.com/privacy-policy" />
        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta
          property="og:url"
          content="https://convoyafro.com/privacy-policy"
        />
        <meta property="og:title" content="Privacy Policy | BGM Library" />
        <meta
        ...
        <meta
          ...
          content="https://convoyafro.com/privacy-policy"
        />
        <meta property="twitter:title" content="Privacy Policy | BGM Library" />
        <meta
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="bg-primary rounded-lg shadow-lg p-6 text-white">
          ...
          <p className="mb-4">
            ...
            are located outside [Your Country] and choose to provide information
            to us, please note that we transfer the data, including personal
            data, to [Your Country] and process it there.
          </p>

          <h2 className="text-2xl font-semibold mb-2">7. Use of Cookies</h2>
          <p className="mb-4">
            Our website uses cookies to enhance your browsing experience and
            provide personalized services. We use the following types of
            cookies:
          </p>
          <ul className="list-disc list-inside ml-4 mb-4">
            <li>
            ...
            <li>
              Analytics cookies: We use these cookies to analyze how visitors
              use our website and to monitor website performance. This helps us
              to provide a high-quality experience by identifying and fixing any
              issues quickly.
            </li>
            <li>
              Advertising cookies: These cookies are used to make advertising
              messages more relevant to you and your interests. They also
          ...
          <p className="mb-4">
            You will be asked to consent to our use of cookies every 24 hours.
            You can adjust your cookie preferences at any time by declining or
